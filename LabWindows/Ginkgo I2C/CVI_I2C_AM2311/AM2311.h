...
#define  PANEL                            1
#define  PANEL_NUMERICMETER_TMP           2       /* control type: scale, callback function: (none) */
#define  PANEL_NUMERICMETER_HUM           3       /* control type: scale, callback function: (none) */
...
#define  PANEL_TIMER_START                10      /* control type: timer, callback function: MeasureCallback */
