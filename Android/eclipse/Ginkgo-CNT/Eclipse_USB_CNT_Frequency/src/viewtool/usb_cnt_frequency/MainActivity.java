...
public class MainActivity extends Activity {
    private static final String ACTION_USB_PERMISSION = "viewtool.usb_cnt_frequency.USB_PERMISSION";
    Timer timer;
    EditText printView;
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if(ret != mGinkgoDriver.ErrorType.ERR_SUCCESS){
                                    ...
                                    printView.append(String.format("Counter frequency %d \n", CntValue[0]));
                                }
                                // Clear counter
                                CntValue[0] = 0;
                                ret = mGinkgoDriver.ControlCNT.CNT_SetCounter((byte)(1<<0), CntValue);
                                if(ret != mGinkgoDriver.ErrorType.ERR_SUCCESS){
                                    printView.append("Set counter value error!\n");
                                    return;
                                }
                            }
                        });
